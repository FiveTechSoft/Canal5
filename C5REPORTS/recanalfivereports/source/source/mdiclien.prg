...
METHOD Paint() CLASS TMdiClient
   ...
   if IsIconic( ::hWnd )
      ...
      FillSolidRect( ::hDC, GetClientRect( ::hWnd ), ::oWnd:nClrPane )
...
//***************************************************************************************************
   METHOD HandleEvent( nMsg, nWParam, nLParam ) CLASS TMdiClient
//***************************************************************************************************

    #define WM_MDIMAXIMIZE                     549
   if nMsg == WM_MDIMAXIMIZE
      MsgInfo( "Maximize" )
      return 0
   endif
