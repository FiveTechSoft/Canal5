...
METHOD New( nRow, nCol, nWidth, nHeigth, bLine, aHeaders, aColSizes, oWnd,;
   ...
   //::nLineStyle    := LINES_3D
   ::nLineStyle    := rgb(173,197,229) //LINES_GRAY
...
METHOD wBrwLine( hWnd, hDC, nRowPos, aValues, aColSizes,;
   ...
   for n := nColPos to Len( aValues )
      ...
      if ValType( aValues[ n ] ) == "N" .or. nRowPos == 0
         if n <= 1
            hBrush = CreateSolidBrush( rgb(173,197,229) ) //rgb(212,208,200)
         else
            //if lBar .and. n == 3
         ...
         if nColAct != nil .and. n == nColAct
            ...
            if nRowPos != 0
               if n == 3
                  SetTextColor( hDC, ::nClrText )
                  if aValues[1] != 0
                     SetBkColor( hDC, rgb(173,197,229) ) //rgb(212,208,200) )
                  else
                     SetBkColor( hDC, ::nClrPane )
                  endif
               else
                  ...
                  SetBkColor( hDC, If( nRowPos == 0, rgb(173,197,229) , If( nColAct == nil, if( aValues[1] != 0,rgb(173,197,229),nClrPane), GetSysColor( COLOR_WINDOW ) ) ) )
               endif
            endif
         endif
         ...
         if nRowPos == 0
            ...
            do case
               ...
               case nLineStyle == LINES_GRAY
                    hPen = CreatePen( PS_SOLID, 1, rgb(173,197,229) )//rgb(212,208,200) )
